...
/**
 * 性格，影响宝可梦两项能力值的成长（一项提高 10%，一项降低 10%）。
 */
public class Nature implements Serializable {
    ...
    /** 能力提升倍率。 */
    private static final double INCREASED_MULTIPLIER = 1.1;

    /** 能力降低倍率。 */
    private static final double DECREASED_MULTIPLIER = 0.9;
     ...
     * 返回被该性格提升的能力项。
     *
     * @return 提升的能力项，无修正时为空
     */
    public Optional<StatModifier> getIncreasedStat() {
        return Optional.ofNullable(increasedStat);
    }

    /**
     * 返回被该性格降低的能力项。
     *
     * @return 降低的能力项，无修正时为空
     */
    public Optional<StatModifier> getDecreasedStat() {
        return Optional.ofNullable(decreasedStat);
    }
     ...
     *
     * @param stat 能力项
     * @return 提升返回 1.1，降低返回 0.9，无修正返回 1.0
     */
