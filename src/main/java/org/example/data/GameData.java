...
public final class GameData {
    ...
    private void registerBuiltinItems() {
        ...
        putItem("i_poke_ball", "精灵球", ItemCategory.POKE_BALL, 1.5);
        putItem("i_great_ball", "超级球", ItemCategory.POKE_BALL, 2.5);
        putItem("i_ultra_ball", "高级球", ItemCategory.POKE_BALL, 4);
